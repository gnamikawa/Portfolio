...
This will install `npm i -g typescript` globally allowing you to use it within any project that you have on your computer. We are now going to create a very simple project using TypeScript. Below you will see an image of the file structure of our project.
